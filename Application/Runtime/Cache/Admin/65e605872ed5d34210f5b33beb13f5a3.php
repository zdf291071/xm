        ...
        <div class="col-md-8 col-sm-12 col-xs-12" style="width:1060px;margin-left:16px;">
            ...
            <div class="panel panel-default">
                ...
                <div class="list_div mt10">
                    ...
                    <form action="<<?php echo U('Admin-User/del_user');?>>" method="GET">
                        <table width="100%" cellspacing="1" cellpadding="3" id="table">
                            <tr>
                                <th align="center" width="30px">编号</th>
                                <th width="80px">会员名</th>
                                <th width="100px">邮箱地址</th>
                            ...
                            <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                    <td name="id" align="center"><?php echo ($vo["id"]); ?></td>
                                    <td align="center"><span><?php echo ($vo["name"]); ?></span></td>
                                    <td align="center"><?php echo ($vo["email"]); ?></td>
                                    <td align="center"><?php echo ($vo["phone"]); ?></td>
                                    <td align="center" width="150px"><?php echo ($vo["createtime"]); ?></td>
                                    <td align="center">
                                        <a title="移除" href="<?php echo U('Admin/User/del_user/');?>?id=<?php echo ($vo['id']); ?>"><img width="16" height="16" border="0" src="<?php echo (ADMIN_IMG_URL); ?>icon_drop.gif"></a>
                                    </td>

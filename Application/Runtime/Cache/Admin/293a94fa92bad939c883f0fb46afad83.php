    ...
    <div id="page-wrapper">
        ...
        <div class="col-md-8 col-sm-12 col-xs-12" style="width:1060px;margin-left:16px;">
            ...
            <div class="panel panel-default">
                ...
                <form name="theForm" id="demo" action="<?php echo U('Admin/Photo/add_photo/');?>" method="post" onSubmit="return Validator.Validate(this,2)" enctype="multipart/form-data">

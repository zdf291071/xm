            ...
            <div class="panel panel-default">
                ...
                <form name="theForm" id="demo" action="<?php echo U('Goods/add_goods');?>" method="POST" enctype="multipart/form-data" onSubmit="return Validator.Validate(this,2)">
                    <table width="100%" bgcolor="white">
                        ...
                        <tr>
                            <td align="right">图片预览1：</td>
                            <td><img src="<?php echo (IMG_GOODS); echo ($data["goods_img"]); ?>" width="440" height="623"></td>
                        </tr>
                        <tr>
                            <td align="right">图片预览2：</td>
                            <td><img src="<?php echo (IMG_GOODS); echo ($data["goods_img2"]); ?>" width="440" height="623"></td>
                        </tr>

                        <tr>
                            <td align="right">商品分类：</td>
                            <td><?php echo ($data["goods_catagory_id"]); ?></td>
                        </tr>
                        ...
                        <tr>
                            <td align="center"><a href="index.html">返回上一页</a> </td>
                        </tr>
                    </table>
                </form>
            </div>

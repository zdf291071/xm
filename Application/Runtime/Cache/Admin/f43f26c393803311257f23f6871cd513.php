    ...
    <div id="page-wrapper">
        ...
        <div class="col-md-8 col-sm-12 col-xs-12" style="width:1060px;margin-left:16px;">
            ...
            <div class="panel panel-default">
                ...
                <form action="<?php echo U('List/del_list');?>" method="POST">
                    <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
                        ...
                        <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr align="center">
                                <td align="left">
                                    <input type="text" disabled="disabled" class="check" name="<?php echo ($vo["list_name"]); ?>" value="<?php echo ($vo["list_name"]); ?>">
                                <td width="10%" align="center"><?php echo ($vo["list_pname"]); ?></td>
                                <td align="center" width="20%">
                                    <a href="<?php echo U('Admin/List/edit_list/');?>?name=<?php echo ($vo['list_name']); ?>">编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                    <a href="<?php echo U('Admin/List/del_list/');?>?list_name=<?php echo ($vo['list_name']); ?>">删除</a>
                                </td>

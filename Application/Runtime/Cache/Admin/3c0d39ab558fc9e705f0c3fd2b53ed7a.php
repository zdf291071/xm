    ...
    <div id="page-wrapper">
        ...
        <div class="col-md-8 col-sm-12 col-xs-12" style="width:1060px;margin-left:16px;">
            ...
            <div class="panel panel-default">
                ...
                <form action="<?php echo U('Home/Active/del_news');?>" method="POST">
                    <table width="100%" cellspacing="1" cellpadding="3" id="table">
                        ...
                        <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                <td id="id" style="text-align:center;"><?php echo ($vo["news_id"]); ?></td>
                                <td><?php echo ($vo["news_title"]); ?></td>
                                <td align="center"><?php echo ($vo["news_date"]); ?></td>
                                <td align="center">
                                    <a title="编辑" href="<?php echo U('Admin/Active/edit_active/');?>?id=<?php echo ($vo['news_id']); ?>"><img width="16" height="16" border="0" src="<?php echo (ADMIN_IMG_URL); ?>/icon_edit.gif"></a>&nbsp;&nbsp;
                                    <a title="移除" href="<?php echo U('Admin/Active/delete_active/');?>?id=<?php echo ($vo['news_id']); ?>" id="del"><img width="16" height="16" border="0" src="<?php echo (ADMIN_IMG_URL); ?>/icon_drop.gif"></a>
                                </td>

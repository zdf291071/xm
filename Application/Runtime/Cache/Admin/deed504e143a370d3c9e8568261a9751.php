    ...
    <div id="page-wrapper">
        ...
        <div class="col-md-8 col-sm-12 col-xs-12" style="width:1060px;margin-left:16px;">
            ...
            <div class="panel panel-default">
                ...
                <form name="theForm" id="demo" action="<?php echo U('List/update_list');?>" method="post" onSubmit="return Validator.Validate(this,2)" enctype="multipart/form-data">
                    <table width="100%" bgcolor="white">
                        <tr>
                            <td align="right">上级分类：</td>
                            <td>
                                <select name="list_pname">
                                    <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k; if($v["list_name"] != $list_name): ?><option id="<?php echo ($v["list_id"]); ?>"><?php echo ($v["list_id"]); ?>,<?php echo ($v["list_name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="list_name" class="input_text news_title" value="<?php echo ($list_name); ?>"><span class="require-field">*</span></td>
                        </tr>
